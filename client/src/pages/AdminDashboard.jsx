          ...
          <div style={{ position: 'fixed', inset: 0, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.5rem', marginBottom: '3rem' }}>
                <div className="glass-card" style={{ padding: '1.25rem', textAlign: 'center', background: '#f8fafc', border: '1px solid #e2e8f0' }}>
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '0.5rem' }}>Unit 1: Hibernate</p>
                  <p style={{ fontSize: '1.5rem', fontWeight: '700', color: 'var(--text-main)' }}>{selectedParticipant.unit1Marks}</p>
                </div>
                <div className="glass-card" style={{ padding: '1.25rem', textAlign: 'center', background: '#f8fafc', border: '1px solid #e2e8f0' }}>
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '0.5rem' }}>Unit 2: Spring</p>
                  <p style={{ fontSize: '1.5rem', fontWeight: '700', color: 'var(--text-main)' }}>{selectedParticipant.unit2Marks}</p>
                </div>
                <div className="glass-card" style={{ padding: '1.25rem', textAlign: 'center', background: '#f8fafc', border: '1px solid #e2e8f0' }}>
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '0.5rem' }}>Unit 3: Spring Boot</p>
                  <p style={{ fontSize: '1.5rem', fontWeight: '700', color: 'var(--text-main)' }}>{selectedParticipant.unit3Marks}</p>
                </div>
                <div className="glass-card" style={{ padding: '1.25rem', textAlign: 'center', background: '#f8fafc', border: '1px solid #e2e8f0' }}>
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '0.5rem' }}>Unit 4: React</p>
                  <p style={{ fontSize: '1.5rem', fontWeight: '700', color: 'var(--text-main)' }}>{selectedParticipant.unit4Marks}</p>
                </div>
              </div>

              <h3 style={{ marginBottom: '1.5rem', borderBottom: '1px solid #e2e8f0', paddingBottom: '0.75rem', color: 'var(--text-main)' }}>Response Summary</h3>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                {Object.entries(selectedParticipant.responses || {}).map(([qId, selectedIdx]) => {
                  ...
                  return (
                    <div key={qId} className="glass-card" style={{ padding: '1.5rem', background: '#f8fafc', border: '1px solid #e2e8f0', borderLeft: `4px solid ${isCorrect ? '#10b981' : '#f43f5e'}` }}>
                      <p style={{ fontWeight: '600', marginBottom: '1rem', color: 'var(--text-main)' }}>{question.questionText}</p>
